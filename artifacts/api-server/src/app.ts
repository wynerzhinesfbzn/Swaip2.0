...
app.use((_req, res, next) => {
  ...
  res.setHeader(
    ...
    [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' https://cdnjs.cloudflare.com https://cdn.emulatorjs.org",
      "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdn.emulatorjs.org",
      "font-src 'self' https://fonts.gstatic.com https://cdn.emulatorjs.org",
      "img-src 'self' data: blob: https:",
      "media-src 'self' blob: https:",
      "connect-src 'self' https: wss: blob:",
      "worker-src 'self' blob: https://cdn.emulatorjs.org",
      "frame-src https://www.youtube-nocookie.com https://www.youtube.com https://rutube.ru https://vk.com https://vkvideo.ru https://player.vimeo.com https://clips.twitch.tv https://player.twitch.tv https://mingame.ru https://bloxd.io https://deadshot.io https://playgama.com https://s3.ru1.storage.beget.cloud 'self'",
...
/* Увеличенный лимит JSON для маршрутов с фото (base64 фото до 30 МБ) */
app.use("/api/assistants", express.json({ limit: '50mb' }));
