/* ═══════════════════════════════════════════════════════
   CONTENT GUARD — фильтр запрещённого контента SWAP
...
const DRUG_PATTERNS = [
  /* Русский — наркотики в любом порядке слов */
  /купить\s+наркотик/i,
  /куплю\s+наркотик/i,
  /продам\s+наркотик/i,
  /наркотик\S*\s+(?:продаю|куплю|заказ|доставк|купить|продать|дёшево|дешево)/i,
  /(?:продаю|куплю|заказ|доставк|купить|продать|дёшево|дешево)\s+наркотик/i,
  /кокаин/i, /героин/i, /метамфетамин/i, /мефедрон/i, /экстази/i,
  /курительн[ые]\s+смес/i, /амфетамин/i,
  /кристалл[ы]?\s+(?:продаю|куплю|мет)/i,
  /спайс\s+(?:купить|продать|заказ)/i,
  /(?:купить|продать|куплю|продам)\s+спайс/i,
  /марихуан\S*\s+(?:купить|продать|доставк)/i,
  /(?:купить|продать|куплю|продам)\s+марихуан/i,
  /гашиш\s+(?:купить|продать)/i, /(?:купить|продать|куплю)\s+гашиш/i,
  /lsd\s+(?:купить|продать)/i, /(?:купить|продать|куплю)\s+lsd/i,
  /закладк\S*\s+нарк/i, /нарк\S*\s+закладк/i,
  /телеграм\s+нарк/i,
  /* English */
