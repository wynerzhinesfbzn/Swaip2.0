  ...
  const DocText=({type}:{type:string})=>{
    ...
    if(type==='privacy') return(
      <div style={{fontSize:13,color:c.mid,lineHeight:1.8}}>
        ...
        <p style={{margin:'0 0 16px'}}>Настоящая Политика конфиденциальности описывает, как SWAP («мы», «нас») собирает, использует, хранит и защищает данные пользователей платформы.</p>
        <p style={{margin:'0 0 8px',fontWeight:800,color:c.light}}>1. Какие данные мы собираем</p>
        <p style={{margin:'0 0 16px'}}>• Имя и никнейм, указанные при регистрации{'\n'}• Хэш-идентификатор аккаунта{'\n'}• Фотография профиля и обложка (по желанию пользователя){'\n'}• Номер телефона и контакты (только если пользователь добавил){'\n'}• Публикации, виджеты и медиафайлы, размещённые пользователем{'\n'}• Технические данные: IP-адрес, тип устройства, браузер, операционная система{'\n'}• Данные о сессиях и активности в приложении</p>
        <p style={{margin:'0 0 8px',fontWeight:800,color:c.light}}>2. Цели обработки данных</p>
        <p style={{margin:'0 0 16px'}}>Мы обрабатываем данные для: обеспечения работы сервиса и аутентификации; персонализации контента; безопасности платформы и предотвращения мошенничества; технической поддержки пользователей.</p>
        <p style={{margin:'0 0 8px',fontWeight:800,color:c.light}}>3. Хранение данных</p>
        <p style={{margin:'0 0 16px'}}>Данные хранятся на защищённых серверах SWAP. Мы применяем современные технические меры для защиты информации от несанкционированного доступа.</p>
        <p style={{margin:'0 0 8px',fontWeight:800,color:c.light}}>4. Передача данных третьим лицам</p>
        <p style={{margin:'0 0 16px'}}>Мы не передаём данные третьим лицам без согласия пользователя.</p>
        <p style={{margin:'0 0 8px',fontWeight:800,color:c.light}}>5. Права пользователей</p>
        <p style={{margin:'0 0 16px'}}>Вы имеете право: получить информацию об обработке ваших данных; потребовать исправления или удаления данных («право на забвение»); отозвать согласие на обработку данных.</p>
        <p style={{margin:'0 0 8px',fontWeight:800,color:c.light}}>6. Контакты</p>
        <p style={{margin:'0 0 16px'}}>По вопросам, связанным с обработкой данных: <strong>privacy@swaip.ru</strong></p>
        <p style={{margin:'0 0 0',color:c.sub,fontSize:11}}>© {now} SWAP. Все права защищены.</p>
      </div>
    );
    if(type==='terms') return(
      <div style={{fontSize:13,color:c.mid,lineHeight:1.8}}>
        ...
        <p style={{margin:'0 0 16px'}}>Настоящее Пользовательское соглашение регулирует отношения между SWAP и пользователями платформы. Используя SWAP, вы соглашаетесь с условиями настоящего Соглашения.</p>
        ...
        <p style={{margin:'0 0 16px'}}>Запрещается: размещение незаконного контента; распространение спама и вредоносных программ; призывы к насилию и экстремизму; нарушение прав несовершеннолетних; харассмент и травля других пользователей.</p>
        ...
        <p style={{margin:'0 0 16px'}}>SWAP не несёт ответственности за контент, созданный пользователями. Пользователь несёт ответственность за соответствие размещаемых материалов применимым нормам.</p>
        <p style={{margin:'0 0 8px',fontWeight:800,color:c.light}}>6. Разрешение споров</p>
        <p style={{margin:'0 0 16px'}}>Все споры решаются путём переговоров. При невозможности разрешить спор мирно стороны вправе обратиться в суд по месту нахождения пользователя.</p>
        <p style={{margin:'0 0 0',color:c.sub,fontSize:11}}>По вопросам: <strong>legal@swaip.ru</strong></p>
      </div>
    );
    if(type==='pd') return(
      <div style={{fontSize:13,color:c.mid,lineHeight:1.8}}>
        <h3 style={{color:c.light,fontSize:15,fontWeight:900,margin:'0 0 16px'}}>Политика обработки данных</h3>
        <p style={{margin:'0 0 12px'}}>Используя приложение SWAP, вы соглашаетесь на обработку ваших данных в соответствии с настоящей политикой.</p>
        <p style={{margin:'0 0 8px',fontWeight:800,color:c.light}}>Оператор:</p>
        <p style={{margin:'0 0 16px'}}>SWAP<br/>Email: privacy@swaip.ru</p>
        <p style={{margin:'0 0 8px',fontWeight:800,color:c.light}}>Цели обработки:</p>
        <p style={{margin:'0 0 16px'}}>• Идентификация и аутентификация пользователей{'\n'}• Обеспечение работы платформы{'\n'}• Персонализация контента{'\n'}• Обеспечение безопасности платформы</p>
        <p style={{margin:'0 0 8px',fontWeight:800,color:c.light}}>Данные:</p>
        ...
        <p style={{margin:'0 0 16px'}}>Данные хранятся в течение срока действия аккаунта и 90 дней после его удаления.</p>
        ...
        <p style={{margin:'0 0 0',color:c.sub,fontSize:11}}>Данные не передаются третьим лицам без вашего согласия.</p>
      </div>
    );
    return(
      <div style={{fontSize:13,color:c.mid,lineHeight:1.8}}>
        ...
        <p style={{margin:'0 0 16px'}}>Все данные хранятся только на вашем устройстве или на защищённых серверах SWAP. Мы не используем сторонние аналитические сервисы без вашего явного согласия.</p>
